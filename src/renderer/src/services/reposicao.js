...
export const reposicao = {
  ...
  async byId(id) {
    ...
    const { data: itens, error: e2 } = await supabase
      ...
      .select('id, pedido_reposicao_id, referencia, tamanho, qtd, qtd_sugerida, vendido_periodo, estoque_cd, ja_pedido, nome, tipo, classe, colecao, reffornecedor, codigo_ponto_e, foto_url, tipo_grade, valor_unitario, cor')
